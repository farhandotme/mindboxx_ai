"""
Drop-in AUREX plugin template.

Copy this file, rename it (no leading underscore), fill in PLUGIN and run().
No other file needs to change — AUREX discovers this automatically at startup.
"""
...
def run(parameters: dict, player=None, session_memory=None) -> str:
    ...
    player: the AUREXUI instance — use player.write_log(f"AUREX: ...") to log,
