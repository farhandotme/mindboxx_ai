"""
Local wake-word detection for AUREX ("Hey AUREX").
...
CPU. The pretrained wake phrase used here is "Hey AUREX".
"""
...
# Pretrained openwakeword model that listens for "Hey AUREX".
WAKE_MODEL = "hey_AUREX"
...
class WakeWordDetector:
    ...
    def start(self) -> bool:
        ...
        self._thread.start()
        self._logger("Wake word: listening for 'Hey AUREX'.")
        return True
        ...
        while self._running:
            try:
                ...
                if isinstance(scores, dict):
                    # match the AUREX model regardless of exact key suffix
