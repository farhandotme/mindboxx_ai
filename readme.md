...
| Feature | Description |
|---|---|
| 🎙️ Wake Word | Local **"Hey AUREX"** detection — sleeps until called, auto-sleeps after 2 min of silence, and never streams audio while asleep. Opt-in, one-click download, toggle & manual sleep/wake from the UI |
...
| 〰️ Reactive HUD | Waveform and reactor core pulse to real audio — your mic while listening, AUREX while speaking |
...
Engineered by a developer building a real-world AUREX-style assistant.
